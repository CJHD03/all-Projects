        ...
        try:
            ...
            while not done:
                ...
                if not done:
                    ...
                    # time.sleep(random.randint(1, 2))   //this might work

                    # event = self.wait_for_event()
                    # debugevent = self.eventQueue2String()
                    # print(debugevent)

                    # The sender
                    # will wait for an event. The only event that will
                    # happen is the arrival of the acknowledgement frame. The sender
                    # does not need that frame (which is empty anyway).
                    # It only needs to know that it arrived.
    ...
    def receiver(self, name):
        ...
        try:
            ...
            while not done:
                ...
                ackFrame = Frame(type="Empty", seq=None, ack=True)
